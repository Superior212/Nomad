...
export const NomadCan = [
  {
    ...
    text: "Make payments from solana blockchain without <br> internet connection",
  },
  {
    icon: MemoDebitCard,
    title: "Crypto debit card for <br>  worldwide acceptance",
    text: "Spend straight from your Solana wallet anywhere <br> Mastercard and Visa are accepted",
  },
  {
    icon: MemoEasyPayment,
    title: "Easy Bill Payments without <br>  bank account  issues",
    text: "No need to interact with your Nigerian bank account <br> before you make paymet",
  },
  {
    icon: MemoLocalCurrency,
    title: "Pay African merchants in  <br>  local currencies",
    text: "Pay African merchants directly from your Solana <br> wallet in their local currency",
  },
];
